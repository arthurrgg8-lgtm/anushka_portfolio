          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 mb-12 px-2 sm:px-0">
              <Link
                ...
                className="group/wa relative flex items-center justify-center gap-3 overflow-hidden rounded-full bg-[#25D366] px-10 py-4 text-base font-bold text-white transition-all duration-300 hover:bg-[#20BD5C] hover:-translate-y-1 hover:shadow-xl hover:shadow-[#25D366]/40 shadow-lg shadow-[#25D366]/20"
              >
                <svg className="h-6 w-6 transition-transform duration-300 group-hover/wa:scale-110 group-hover/wa:rotate-12" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link
                href={emailUrl}
                className="group/email relative flex items-center justify-center gap-3 overflow-hidden rounded-full bg-secondary px-10 py-4 text-base font-bold text-primary transition-all duration-300 hover:bg-secondary-light hover:-translate-y-1 hover:shadow-xl hover:shadow-secondary/40 shadow-lg shadow-secondary/20"
              >
                ...
                <svg className="relative z-10 h-6 w-6 transition-transform duration-300 group-hover/email:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm text-text-muted">
              <div className="flex flex-col items-center gap-3 rounded-2xl bg-primary-light/30 border border-border/50 p-6 transition-all duration-300 hover:border-secondary/30 hover:bg-primary-light/50">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary/10 text-secondary">
                  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                </div>
                <span className="font-semibold text-text-primary tracking-wide">{data.contact.phone}</span>
                <span className="text-[10px] uppercase tracking-widest opacity-60">Phone Support</span>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 rounded-2xl bg-primary-light/30 border border-border/50 p-6 transition-all duration-300 hover:border-secondary/30 hover:bg-primary-light/50">
                ...
                <span className="font-semibold text-text-primary tracking-wide truncate max-w-full px-2">{data.contact.email}</span>
                <span className="text-[10px] uppercase tracking-widest opacity-60">Official Email</span>
              </div>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="group/loc flex flex-col items-center gap-3 rounded-2xl bg-primary-light/30 border border-border/50 p-6 transition-all duration-300 hover:border-secondary/30 hover:bg-primary-light/50"
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary/10 text-secondary transition-transform duration-300 group-hover/loc:scale-110">
                  <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <span className="font-semibold text-text-primary tracking-wide text-center">{data.location}</span>
                <span className="text-[10px] uppercase tracking-widest opacity-60">Our Location</span>
              </a>
            </div>

            {/* Google Maps embed */}
            <div className="mt-12 rounded-2xl overflow-hidden border border-border gold-glow shadow-xl shadow-black/30">
              <iframe
